...
export const braintreePaymentController = async (req, res) => {
  try {
    ...
    console.log("hello", total,nonce,cart);
...
export const getAllProducts = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Succesfully got all Products",
      allproduct,
...
export const getSingleProducts = async (req, res) => {
  try {
    ...
    res.status(200).send({
      success: true,
      message: "Succesfully got Single Products",
      allproduct,
      count: allproduct.length,
    });
  } catch (error) {
...
export const productListController = async (req, res) => {
  try {
    ...
    const products = await productModel
      ...
      .limit(perpage)
      .sort({ createdAt: -1 });
    res.status(200).send({ success: true, message: "Got it", products });
  } catch (e) {
    console.log(e);
    res.status(400).send({
      success: false,
...
export const productCategoryController = async (req, res) => {
  try {
    ...
    // console.log(req.params.slug + " "+category);
